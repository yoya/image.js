...
onmessage = function(e) {
    ...
    const [border, blurKernelSize, blurKernel, amp] = [params.border, params.blurKernelSize, params.blurKernel, params.amp];
    console.log(params, blurKernel);
    ...
    for (let y = 0 ; y < height; y++) {
	    ...
	    let rgba;
	        ...
	        rgba = getRGBAmirror(srcImageData, x, y, y_border);
                ...
                rgba = convolution(srcImageData, x, y, blurKernel, blurKernelSize, y_border);
                rgba[0] *= amp/100;
                rgba[1] *= amp/100;
                rgba[2] *= amp/100;
            }
