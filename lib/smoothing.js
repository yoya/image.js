...
function convertSmoothing(srcImageData, params) {
	...
	for (var y = 0 ; y < height; y++) {
		...
		var rgba = smoothingNormal(srcImageData, x, y,
...
function smoothingNormal(srcImageData, srcX, srcY, filterMatrix, convWindow) {
