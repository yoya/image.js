...
class IO_ICC {
	...
	header['CMMOptions'] = {
	    ...
	    toString:function() {
		return 'EmbedProfile:'+this['EmbedProfile']+
		    ' Independently:'+this['Independently'];
	    }
	};
	header['DeviceManufacturer'] = binary.getUint32();
	    ...
	    toString:function() {
		return 'ReflectiveOrTransparency:'+this['ReflectiveOrTransparency']+
		    ' GlossyOnMatte:'+this['GlossyOnMatte'];
	    }
	};
